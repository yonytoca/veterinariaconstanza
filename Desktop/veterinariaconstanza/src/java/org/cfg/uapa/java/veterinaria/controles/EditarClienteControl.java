 ...
 * @author EDUARDO
 */
@WebServlet(name = "EditarClienteControl", urlPatterns = {"/EditarClienteControl"})
public class EditarClienteControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cliente client = ServicioCliente.getInstancia().getClientePorId(Integer.valueOf(id));
